...
void ABlasterPlayerController::SetHUDMatchCountdown(float CountdownTime, float MatchEndWarningThresholdTime)
{
    BlasterHUD = BlasterHUD == nullptr ? Cast<ABlasterHUD>(GetHUD()) : BlasterHUD;
    ...
    if (bHUDValid)
    {
        ...
        if (CountdownTime <= MatchEndWarningThresholdTime)
        {
            BlasterHUD->CharacterOverlay->PlayAnimation(BlasterHUD->CharacterOverlay->MatchEndingWarning);
        }
    }
}
...
void ABlasterPlayerController::SetHUDTime()
{
    ...
    if (CountdownInt != SecondsLeft)
    {
        ...
        if (MatchState == MatchState::InProgress)
        {
            ...
            if (BlasterGameMode)
            {
                MatchEndWarningThresholdTime = BlasterGameMode->MatchEndWarningThresholdTime;
            }
            SetHUDMatchCountdown(TimeLeft, MatchEndWarningThresholdTime);
        }
    }
